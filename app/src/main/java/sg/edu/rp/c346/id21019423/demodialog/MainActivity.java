package sg.edu.rp.c346.id21019423.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Inflate the numbers.xml layout file
                LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.numbers, null);

                // Obtain the UI component in the numbers.xml layout
                // It needs to be defined as "final", so that it can be used in the onClick() method later
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // Extract the text entered by the user
                        Integer number = Integer.valueOf(etInput1.getText().toString()) + Integer.valueOf(etInput2.getText().toString());
                        // Set the text to the TextView
                        tvEx3.setText("The sum is " + number.toString());
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
                AlertDialog myDialog = myBuilder.create();
